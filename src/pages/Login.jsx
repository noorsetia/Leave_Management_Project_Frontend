...
import { GraduationCap, LogIn, AlertCircle, Mail, Lock, User, Github } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 px-4 py-12">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-blue-100">Advanced Leave Management System</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 animate-slide-up">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg flex items-center justify-center"
            >
              {loading ? (
                <>
